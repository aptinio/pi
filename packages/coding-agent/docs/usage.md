...
| Copy response | Ctrl+X copies the selected message in `/tree`; otherwise it copies the active fullscreen text selection when present, or the last assistant message |
